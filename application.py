...
def render_artifact_dir(req_path):
    ...
    result = {"files": files, "parent_folder": os.path.dirname(abs_path), "parent_label": abs_path}
...
def predict():  # go to predict url
    ...
    try:
        if request.method == "POST":
            ...
            backorder_df = (
                backorder_data.get_backorder_input_data_frame()
            )  # calling function from backorder predictor entity to save data frame
