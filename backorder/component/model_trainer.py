...
from backorder.entity.model_factory import (
    GridSearchedBestModel,
    MetricInfoArtifact,
    ModelFactory,
    evaluate_classification_model,
)
from backorder.io import load_numpy_array_data, load_object, save_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        logging.info(f"Expected accuracy: {base_accuracy}")  # base accuracy minimum required acc
