...
TRAINING_PIPELINE_CONFIG_KEY = "training_pipeline_config"  # checks which config.yaml then inside information is passed(like a gate and then proceed)
...
DATA_INGESTION_ARTIFACT_DIR = (
    "data_ingestion"  # constant for artifact(o/p of component) directory  or  location
)
